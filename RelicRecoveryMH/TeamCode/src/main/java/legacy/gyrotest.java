 ...
 */
@Disabled
@Autonomous(name = "gyrotest", group = "Force of Oros")
public class gyrotest extends LinearOpMode
{
    ...
    */
    ...
    {
        //converted the gyro to 360 degrees then converted it back, then did the wrapper
        updateAngles();
        double currentAngle = angles.firstAngle;
        currentAngle += 180;
        double desiredAngle = dir;
        desiredAngle += 180;
        double target = currentAngle - desiredAngle; //possibly current - desired instead
        target -= 180;
    ...
    public void turnDegrees(double target, double power, double timeoutS) //logic checked out with Albert -- testing right now
    {
        ...
        double error = angles.firstAngle - target; //possibly minus instead
